...
[![GitHub](https://img.shields.io/badge/GitHub-EduarJIM/dulce--encanto-5D4037?style=flat&logo=github)](https://github.com/EduarJIM/dulce-encanto)
...
```bash
git clone https://github.com/EduarJIM/dulce-encanto.git
cd dulce-encanto
